...
local Release = "Custom Release Beta 8"
...
local RayfieldLibrary = {
	...
	Theme = {
		...
		Light = {
			...
			TextColor = Color3.fromRGB(2, 68, 55), -- i need to make all text 240, 240, 240 and base gray on transparency not color to do this
			...
			SelectedTabTextColor = Color3.fromRGB(2, 68, 55),
...
function RayfieldLibrary:Notify(NotificationSettings)
	...
	StarterGui:SetCore("SendNotification", {
		Title = NotificationSettings.Title or "Unknown Title", -- Title of the notification
		Text = NotificationSettings.Content or "Unknown Content", -- Content of the notification
		Icon = NotificationSettings.Image and "rbxassetid://" .. tostring(NotificationSettings.Image) or nil, -- Optional image icon
		Duration = NotificationSettings.Duration or 5, -- Duration of the notification
		Button1 = NotificationSettings.Actions and NotificationSettings.Actions[1] and NotificationSettings.Actions[1].Name or nil, -- First button text
		Button2 = NotificationSettings.Actions and NotificationSettings.Actions[2] and NotificationSettings.Actions[2].Name or nil -- Second button text
	})
	
	if NotificationSettings.Actions then
		for i, Action in ipairs(NotificationSettings.Actions) do
			if i == 1 then
				StarterGui:SetCore("SendNotification", {
					Button1 = Action.Name,
...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.LoadingTitle ~= "Rayfield Interface Suite" then
		LoadingFrame.Version.Text = "Rayfield Undetected UI"
	end
			...
			for _, Option in ipairs(DropdownSettings.Options) do
				...
				DropdownOption.Interact.MouseButton1Click:Connect(function()
					...
					if table.find(DropdownSettings.CurrentOption, Option) then
						...
						TweenService:Create(DropdownOption, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(12, 77, 78)}):Play()
						Debounce = true
						wait(0.2)
					...
					for _, droption in ipairs(Dropdown.List:GetChildren()) do
						if droption.ClassName == "Frame" and droption.Name ~= "Placeholder" and not table.find(DropdownSettings.CurrentOption, droption.Name) then
							TweenService:Create(droption, TweenInfo.new(0.3, Enum.EasingStyle.Quint), {BackgroundColor3 = Color3.fromRGB(2, 67, 68)}):Play()
						end
					end
					if not DropdownSettings.MultipleOptions then
						wait(0.1)
